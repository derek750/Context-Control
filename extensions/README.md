...
1. **Autonomy: Open Panel** (Command Palette) — starts the proxy on **127.0.0.1:8080** by default (**Autonomy: Auto start proxy**).
...
Repository [github.com/derek750/Autonomy](https://github.com/derek750/Autonomy)

---

## License

See [LICENSE](https://github.com/derek750/Autonomy/blob/main/LICENSE)
